...
class TouchControlInputNode: SKSpriteNode, ThumbStickNodeDelegate {
    // MARK: Properties
    ...
    */
    ...
    func thumbStickNode(thumbStickNode: ThumbStickNode, didUpdateXValue xValue: Float, yValue: Float) {
        ...
        if thumbStickNode === leftThumbStickNode {
            NotificationCenter.default.post(name: .controlInputEventTriggered, object: ControlInputEvent.movement(xValue: xValue, yValue: yValue))
        }
    }
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if pauseButton === atPoint(touchPoint) {
                NotificationCenter.default.post(name: .controlInputEventTriggered, object: ControlInputEvent.pause)
                break
            }
        }
